...
public class App {
         static class HashMap<K, V>{  // generic type in which data item type,
             ...
             private int hashFunction(K key){
                int hc = key.hashCode();  // hashcode is form change and returns integer value
                return Math.abs(hc) % N;  // here, we use absolute value of hashcode(+ve value).
             }
             ...
             public boolean containsKey( K key){
                int Bi = hashFunction(key);  // Bucket index(find index of  bucket).
                int Di = searchInLL(key ,Bi); // Data index(find data in the linkdedlist of bucket)
